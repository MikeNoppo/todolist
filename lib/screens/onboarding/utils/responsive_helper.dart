...
class ResponsiveHelper {
  static const String _tag = 'ResponsiveHelper';
  ...
  double get titleFontSize =>
      _responsiveFontSize(28.0, minSize: 24.0, maxSize: 36.0);
  double get subtitleFontSize =>
      _responsiveFontSize(16.0, minSize: 14.0, maxSize: 20.0);
  double get featureTitleFontSize =>
      _responsiveFontSize(16.0, minSize: 14.0, maxSize: 20.0);
  double get featureSubtitleFontSize =>
      _responsiveFontSize(14.0, minSize: 12.0, maxSize: 18.0);
  double get stepTitleFontSize =>
      _responsiveFontSize(18.0, minSize: 16.0, maxSize: 22.0);
  double get stepSubtitleFontSize =>
      _responsiveFontSize(14.0, minSize: 12.0, maxSize: 18.0);

  // Page 3 sizing with minimum font sizes
  double get iconSizePage3 => (screenHeight * 0.1).clamp(50.0, 100.0);
  double get titleFontSizePage3 =>
      _responsiveFontSize(24.0, minSize: 20.0, maxSize: 30.0);
  double get subtitleFontSizePage3 =>
      _responsiveFontSize(14.0, minSize: 12.0, maxSize: 18.0);
  double get permissionTitleFontSize =>
      _responsiveFontSize(14.0, minSize: 12.0, maxSize: 18.0);
  double get permissionSubtitleFontSize =>
      _responsiveFontSize(12.0, minSize: 11.0, maxSize: 16.0);
  double get disclaimerFontSize =>
      _responsiveFontSize(12.0, minSize: 11.0, maxSize: 16.0);
  double get infoTitleFontSize =>
      _responsiveFontSize(13.0, minSize: 12.0, maxSize: 17.0);
  double get infoContentFontSize =>
      _responsiveFontSize(11.0, minSize: 10.0, maxSize: 15.0);
  ...
  double get featureIconContainerSize =>
      (availableHeight * 0.08).clamp(40.0, 80.0);
  double get stepCircleSize => (availableHeight * 0.05).clamp(24.0, 50.0);
  double get stepIconContainerSize =>
      (availableHeight * 0.07).clamp(32.0, 70.0);
  ...
  void debugPrintSizes() {
    ...
    AppLogger.debug(_tag, 'Text Scale Factor: $textScaleFactor');
    AppLogger.debug(_tag, 'Title Font Size: $titleFontSize');
    AppLogger.debug(_tag, 'Subtitle Font Size: $subtitleFontSize');
  }
}
