...
class _AppBlockerSettingsScreenState extends State<AppBlockerSettingsScreen> {
  ...
  Future<void> _loadSettings() async {
    try {
      ...
      AppLogger.info(
        _tag,
        'Loaded monitored distraction apps: ${installedApps.length}',
      );
      ...
      AppLogger.error(
        _tag,
        'Failed to load monitored distraction apps.',
        error: e,
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          SizedBox(height: 12.h),
          Text(
            'Aplikasi Distraksi Dipantau Otomatis',
            style: TextStyle(
              fontSize: 16.sp,
              fontWeight: FontWeight.w600,
              color: Colors.black87,
          ...
          SizedBox(height: 8.h),
          Text(
            'Aplikasi sosial dan game otomatis masuk pemantauan adaptif. Whitelist aplikasi yang tetap boleh dibuka kapan saja.',
  ...
  Widget _buildAppTile({required InstalledFocusApp app}) {
  ...
  Widget _buildBottomInfoCard() {
    final allowCount = _alwaysAllowedApps.values
        ...
        .length;
    final monitoredCount = _installedApps.length - allowCount;
