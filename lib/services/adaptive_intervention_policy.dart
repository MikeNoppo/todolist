...
class AdaptiveInterventionPolicy {
  ...
  AdaptiveInterventionDecision _evaluateByDuration(
    int currentSessionMs,
    ...
    if (currentSessionMs >= hardBlockMs) {
      return const AdaptiveInterventionDecision(
        ...
        message:
            'Aplikasi diblokir karena kamu sudah terlalu lama membuka aplikasi ini, sedangkan ada tugas penting.',
      );
      ...
      return AdaptiveInterventionDecision(
        ...
        message:
            'Peringatan: Kamu sudah cukup lama membuka aplikasi ini. Segera selesaikan tugasmu.',
      ...
      return AdaptiveInterventionDecision(
        ...
        message:
            'Kamu punya tugas penting. Ambil jeda sebentar boleh, tapi jangan terlalu lama.',
